                ...
                <div class="hero jumbotron">
                    <div class="hero-content">
                        <video loop autoplay muted poster="<?php echo get_template_directory_uri(); ?>/videos/video_background.jpg" class="hero-video">
                            ...
                            <?php _e( 'Your browser does not support the HTML5 video tag.', 'crcesolutions' ); ?>
                        </video>
                        <div class="hero-text">
                            <h1><?php bloginfo( 'name' ); ?></h1>
                            <p><?php bloginfo( 'description' ); ?></p>
                            <a class="btn btn-primary btn-lg btn-outline" href="#more"><?php _e( 'Read More', 'crcesolutions' ); ?></a>
                        </div>
                    </div>
                </div>
