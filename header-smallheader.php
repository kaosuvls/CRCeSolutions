    ...
    <body class="<?php echo implode(' ', get_body_class()); ?>">
        <div class="site-container">
            <header class="site-header" id="masthead">
                ...
                <div class="jumbotron jumbo-bkg" style="<?php if($image_attributes) echo 'background-image:url(\''.$image_attributes[0].'\')' ?>">
                    <div class="container dimmer jumbotron-small-inner">
                        <h1><?php the_title(); ?></h1>
                    </div>
                </div>
