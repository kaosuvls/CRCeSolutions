            ...
            <header id="masthead" class="site-header">
                    ...
                    <div class="container-fluid">
                        <div class="navbar-header site-branding">
                            <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                                <span class="sr-only"><?php _e( 'Toggle navigation', 'crcesolutions' ); ?></span>
                ...
                <div class="jumbotron jumbo-bkg" style="<?php if($image_attributes) echo 'background-image:url(\''.$image_attributes[0].'\')' ?>;color:<?php echo '#'.get_header_textcolor() ?>;">
                    <div class="container dimmer jumbotron-inner">
                        ...
                        <p><a class="btn btn-primary btn-lg btn-outline" role="button" href="#more" style="color:<?php echo '#'.get_header_textcolor() ?>;border-color:<?php echo '#'.get_header_textcolor() ?>;"><?php _e( 'Read more', 'crcesolutions' ); ?></a></p>
                    </div>
                </div>
