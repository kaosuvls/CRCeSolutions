...
function pg_starter_setup() {
    ...
    */
    ...
    load_theme_textdomain( 'crcesolutions', get_template_directory() . '/languages' );
...
function pg_starter_widgets_init() {
    ...
    register_sidebar( array(
        'name' => __( 'Footer #01', 'crcesolutions' ),
        'id' => 'footer01_sidebar',
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li>',
        'before_title' => '<h3 class="widgettitle">',
    ...
    register_sidebar( array(
        'name' => __( 'Footer #02', 'crcesolutions' ),
        'id' => 'footer02_sidebar',
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li>',
        'before_title' => '<h3 class="widgettitle">',
    ...
    register_sidebar( array(
        'name' => __( 'Footer #03', 'crcesolutions' ),
        'id' => 'footer03_sidebar',
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li>',
        'before_title' => '<h3 class="widgettitle">',
    ...
    register_sidebar( array(
        'name' => __( 'Footer #04', 'crcesolutions' ),
        'id' => 'footer04_sidebar',
        'before_widget' => '<li id="%1$s" class="widget %2$s">',
        'after_widget' => '</li>',
        'before_title' => '<h3 class="widgettitle">',
...
if ( ! function_exists( 'pg_starter_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'jquerythemepunchtools', get_template_directory_uri() . '/components/js.revolution/src/js/jquery.themepunch.tools.min.js', false, null, true);

    wp_deregister_script( 'jquerythemepunchrevolution' );
    wp_enqueue_script( 'jquerythemepunchrevolution', get_template_directory_uri() . '/components/js.revolution/src/js/jquery.themepunch.revolution.min.js', false, null, true);
    ...
    wp_deregister_style( 'captionsoriginal' );
    wp_enqueue_style( 'captionsoriginal', get_template_directory_uri() . '/components/js.revolution/src/css/captions-original.css', false, null, 'all');

    wp_deregister_style( 'settings' );
    wp_enqueue_style( 'settings', get_template_directory_uri() . '/components/js.revolution/src/css/settings.css', false, null, 'all');
